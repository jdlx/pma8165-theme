...
#initials_table a {
    ...
    -webkit-border-radius: 5px;
    border-radius: 5px;
    <?php echo $_SESSION['PMA_Theme']->getCssGradient('ff0000', '00ff00'); ?>
}
...
input.button:hover {
    ...
    <?php echo $_SESSION['PMA_Theme']->getCssGradient('333', '444'); ?>
    cursor: pointer;
}
...
select[multiple] {
    <?php echo $_SESSION['PMA_Theme']->getCssGradient('rgba(0,0,0,0.2)', 'rgba(0,0,0,0.1)'); ?>
}
...
/*
fieldset .formelement label {margin-right: 1em}
fieldset .formelement label:first-child {margin-right: 0}
*/
fieldset .formelement input[type=checkbox] {margin-left: 2em}
...
.menucontainer {
    ...
    padding-top: 1px;
    -moz-box-shadow: 0px 8px 10px rgba(0,0,0,0.5);
...
ul#topmenu li:hover a.tab:hover,
...
#serverVariables .editLink span.nowrap {float: left}
...
.group {
    ...
    -webkit-border-radius: 4px;
    border-radius: 4px;
    -moz-box-shadow: <?php echo $GLOBALS['text_dir'] === 'rtl' ? '-' : ''; ?>2px 2px 10px rgba(0,0,0,0.3);
    -webkit-box-shadow: <?php echo $GLOBALS['text_dir'] === 'rtl' ? '-' : ''; ?>2px 2px 10px rgba(0,0,0,0.3);
    box-shadow: <?php echo $GLOBALS['text_dir'] === 'rtl' ? '-' : ''; ?>2px 2px 10px rgba(0,0,0,0.3);
    margin-bottom: 1em;
    padding-bottom: 1em;    
}
...
.group-cnt div.notice {
    line-height: 1.5em;
}
.group-cnt input[type=submit] {
    margin-left: 0px;
}
...
.config-form .field-error {
    border-color: <?php echo $GLOBALS['cfg']['ControlColor']; ?> !important;
}
...
.coldrop:hover,
.coldrop-hover {
    background: url(<?php echo $_SESSION['PMA_Theme']->getImgPath('col_drop_white.png');?>);
}
...
#pma_quick_warp .drop_list:hover span {
    color: #999;
}
...
tr:hover td a.favorite_table_anchor span {
    ...
    width: 16px;
    height: 16px;
    background: url(<?php echo $_SESSION['PMA_Theme']->getImgPath('b_favorite_white.png');?>) no-repeat 50% 50%;
}
